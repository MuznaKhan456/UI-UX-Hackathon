...
const Featured = () => {
  return (
    <div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-20 mx-20 md:mx-44 '>
              ...
              <h4 className='mt-4 '>Loudest a la Madison #1<br/> (L&#39;integral)</h4> 
               <p className='mt-4 text-[#737373]'>We focus on ergonomics and meeting <br/> ou where you work. It&#39;s only a <br/>  keystroke away.</p>
             <div className='flex gap-8 mt-8'>
                <p className='flex gap-2 text-[#737373]'><LuAlarmClock className='mt-1 text-primary2'/>22 April 2021</p>
                <p className='flex  gap-2 text-[#737373]'><FaCommentDots className='mt-1 text-primary'/>10 comments</p>
            </div>
